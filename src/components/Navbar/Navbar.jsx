            ...
            <div className="navbar bg-white rounded-b-3xl px-10">
                <div className="navbar-start">
                    ...
                    <div className="flex items-center gap-3">
                        ...
                        <a className="normal-case text-2xl font-extrabold  flex flex-col justify-center items-center">
                            <span className="text-4xl text-black ">T<span className="text-red-600">M</span>X</span>
                            <span className="text-xs">Task Management X</span>
                        </a>
                    </div>
