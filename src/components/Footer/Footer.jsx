        ...
        <div className="bg-neutral">
            <footer className="footer p-10 text-neutral-content max-w-7xl mx-auto flex justify-between">
                <aside>
                    ...
                    <p>Task Management X<br />Providing Reliable Task Managment Website</p>
                </aside>
                <nav>
            ...
            <h1 className="footer-title text-white text-center">Copyright © {copyRightYear.toLocaleString('en-us', { month: 'long' })} {copyRightYear.getFullYear()} - All right reserved</h1>
            {/* <footer className="footer items-center p-4 bg-neutral text-neutral-content max-w-7xl mx-auto">
